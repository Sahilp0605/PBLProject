...
{
    public partial class myLoanApproval : System.Web.UI.UserControl
    {
        int ReturnCode = 0;
        string ReturnMsg = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                BindAppliedLoan(pageApprovalStatus);
            }
        }
        ...
        public void BindAppliedLoan(String pStatus)
        {
            Int64 pMon, pYear;
            ...
            rptApproval.DataSource = BAL.LoanMgmt.GetLoanApprovalList("Loan", pStatus, Session["LoginUserID"].ToString());
        ...
        public void SendApprovalStatus()
        {
            foreach (RepeaterItem i in rptApproval.Items)
            {
                ...
                if (!String.IsNullOrEmpty(hdnID.Value) && hdnID.Value != "0")
                {
                    ...
                    BAL.LoanMgmt.UpdateLoanApproval(objEntity, out ReturnCode, out ReturnMsg);
                }
            }
            BindAppliedLoan(pageApprovalStatus);
        }
