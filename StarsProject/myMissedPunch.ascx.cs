...
{
    public partial class myMissedPunch : System.Web.UI.UserControl
    {
        int ReturnCode = 0;
        string ReturnMsg = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                btnApproveReject.Visible = (hdnView.Value == "dashboarddaily") ? false : true;
                BindMissedPunch(pageApprovalStatus);
            }
        }
        ...
        public void BindMissedPunch(String pStatus)
        {
            int totrec;
            Int64 pMon, pYear;
            ...
            rptApproval.DataSource = BAL.AttendanceMgmt.GetMissedPunchApprovalList(pStatus, Session["LoginUserID"].ToString());
        ...
        public void SendApprovalStatus()
        {
            foreach (RepeaterItem i in rptApproval.Items)
            {
                ...
                if (!String.IsNullOrEmpty(hdnID.Value) && hdnID.Value != "0")
                {
                    ...
                    BAL.AttendanceMgmt.UpdateMissedPunchApproval(objEntity, out ReturnCode, out ReturnMsg);
                }
            }
            BindMissedPunch(pageApprovalStatus);
        }
