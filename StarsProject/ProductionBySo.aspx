                                                            ...
                                                            <HeaderTemplate>
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="center-align width-8">SO No</th>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td class="center-align width-10">
                                                                        <asp:TextBox ID="edQuantity" MaxLength="15" runat="server" ClientIDMode="Static" Text='<%# Eval("Quantity") %>' AutoPostBack="true" OnTextChanged="editItem_TextChanged"  Style="width: 80px; text-align: center;"  TabIndex="6"/>
                                                                    </td>
                                                                    <td class="center-align width-10">
                                                                    ...
                                                                    <td class="center-align width-8"><%# Eval("SONo") %></td>
