...
{
    public partial class PurchaseBillNew : System.Web.UI.Page
    {
        ...
        public void funCalculateTotal()
        {
            ...
            //txtTotOthChrgAfterGST.Text = (
            //    ((!String.IsNullOrEmpty(txtOthChrgAmt1.Text)) ? Convert.ToDecimal(txtOthChrgAmt1.Text) : 0) +
            //    ((!String.IsNullOrEmpty(txtOthChrgAmt2.Text)) ? Convert.ToDecimal(txtOthChrgAmt2.Text) : 0) +
            //    ((!String.IsNullOrEmpty(txtOthChrgAmt3.Text)) ? Convert.ToDecimal(txtOthChrgAmt3.Text) : 0) +
            //    ((!String.IsNullOrEmpty(txtOthChrgAmt4.Text)) ? Convert.ToDecimal(txtOthChrgAmt4.Text) : 0) +
            //    ((!String.IsNullOrEmpty(txtOthChrgAmt5.Text)) ? Convert.ToDecimal(txtOthChrgAmt5.Text) : 0)
            //    ).ToString("0.00");

            //decimal NetAmt = 0;
            //NetAmt = (Convert.ToDecimal(ViewState["totNetAmount"]) + (((!String.IsNullOrEmpty(txtTotOthChrgAfterGST.Text)) ? Convert.ToDecimal(txtTotOthChrgAfterGST.Text) : 0)) - (((!String.IsNullOrEmpty(txtHeadDiscount.Text)) ? Convert.ToDecimal(txtHeadDiscount.Text) : 0)));
            //txtTotNetAmt.Text = Math.Round(NetAmt, 0).ToString("0.00");
            //txtRoff.Text = (Math.Round(NetAmt, 0) - Math.Round(NetAmt, 2)).ToString("0.00");
        }
        ...
        public static void GeneratePurchaseBill(Int64 pkID)
        {
            ...
            if (tmpSerialKey == "SI08-SB94-MY45-RY15" || tmpSerialKey == "TJ7S-06Q2-8R2U-KJWG")
                ...
                GeneratePurchaseBill_Sharvaya(pkID);
            else if (tmpSerialKey == "TJ7S-06Q2-8R2U-KJWG")      // MN Rubber
