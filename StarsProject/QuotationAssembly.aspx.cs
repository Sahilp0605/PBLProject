...
{
    public partial class QuotationAssembly : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if(dtAssembly.Rows.Count>0)
                    dt = dtAssembly.AsEnumerable().Where(r => r.Field<Int64>("FinishProductID") == Convert.ToInt64(hdnFinishProductID.Value)).CopyToDataTable();
                rptQuotationAssembly.DataSource = dt;
                ...
                if (e.CommandName.ToString() == "Save")
                {
                    ...
                    if (_pageValid)
                    {
                        ...
                        if (dtAssembly != null)
                        {
                            ...
                            dr["pkID"] = Rows;
                            dr["FinishProductID"] = hdnFinishProductID.Value;
        ...
        protected void btnSaveAssembly_Click(object sender, EventArgs e)
        {
            ...
            Session.Add("dtAssembly", dtAssembly);
            rptQuotationAssembly.DataSource = dtAssembly;
            rptQuotationAssembly.DataBind();
            string strErr = "";
