...
namespace StarsProject
{
    public partial class Customers : System.Web.UI.Page
    {
        ...
        string _pageErrMsg;
        Boolean IsEmptyCountry, IsEmptyState, IsEmptyCity;
        ...
        //public void BindPriceList(Int64 pCustomerID)
        //{
        //    DataTable dtPrice1 = new DataTable();
        //    dtPrice1 = BAL.CustomerContactsMgmt.GetCustomerPrice(pCustomerID);
        ...
        //    if (String.IsNullOrEmpty(txtCustomerName.Text) || String.IsNullOrEmpty(drpOrgType.SelectedValue))
        //    {
        //        pageValid = false;
        //    }
        //    // ----------------------------------------------------------------
        ...
        //        objEntity.CustomerName = txtCustomerName.Text;
        //        objEntity.CustomerType = drpCustomerType.SelectedValue.Trim();
        //        objEntity.OrgTypeCode = drpOrgType.SelectedValue.Trim();
        //        objEntity.ParentID = Convert.ToInt64(drpReportTo.SelectedValue);
        ...
        //        if ((String.IsNullOrEmpty(hdnCustomerID.Value) || hdnCustomerID.Value == "0") && ReturnCode > 0)
        //        {
        //            hdnCustomerID.Value = ReturnCode.ToString();
        //            objEntity1.CustomerID = ReturnCode;
        //            objEntity1.ContactPerson1 = txtContactPerson1.Text;
        //            objEntity1.ContactDesigCode1 = drpContactDesigCode1.SelectedValue;
        //            objEntity1.ContactNumber1 = txtContactNumber1.Text;
        //            objEntity1.ContactEmail1 = txtContactEmail1.Text;
        //            objEntity1.LoginUserID = Session["LoginUserID"].ToString();
        //            // -------------------------------------------------------------- Insert/Update Record
        //            BAL.CustomerContactsMgmt.AddUpdateCustomerContacts(objEntity1, out ReturnCode, out ReturnMsg);
        //            if (ReturnCode > 0)
        //            {
        //                txtContactPerson1.Text = String.Empty;
        //                drpContactDesigCode1.SelectedValue = "";
        ...
        //            // -------------------------------------------------------------------------
        //        }
        //        ScriptManager.RegisterStartupScript(this, typeof(string), "openContainer", "javascript:btnCloseDialog();openFormContainer();", true);
        //    }
        //}
        ...
        ////    _pageValid = true;
        ////    String strErr = "";
        ////    if (String.IsNullOrEmpty(txtProductC.Text) || String.IsNullOrEmpty(hdnProductID.Value) || String.IsNullOrEmpty(txtConversionC.Text))
        ////    {
        ////        _pageValid = false;

        ////        if (String.IsNullOrEmpty(txtProductC.Text) || String.IsNullOrEmpty(hdnProductID.Value))
        ////            strErr += "<li>" + "Contact Person Name is required." + "</li>";

        ////        if (String.IsNullOrEmpty(txtConversionC.Text))
        ////            strErr += "<li>" + "Contact Number is required." + "</li>";
        ////    }
        ////    // -------------------------------------------------------------------------
        ////    if (_pageValid)
        ...
        ////        string conversion = txtConversionC.Text;
        ////        string rateperbag = txtBagRateC.Text;
        ...
        ////        rptProducts.DataSource = dtProducts;
        ////        rptProducts.DataBind();
        ////        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), Guid.NewGuid().ToString(), "javascript:showcaseError('<li>Product Added .. But Dont Forget To SAVE Entry !');", true);
        ////    }
        ////    else
        ////    {
        ////        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), Guid.NewGuid().ToString(), "javascript:showcaseError('" + strErr + "');", true);
