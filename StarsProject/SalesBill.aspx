                                    ...
                                    <div class="row">
                                        <div class="col m12">
                                            <div class="row">
                                                ...
                                                <div class="input-field col m2">
                                                    <label class="active" for="drpInvoiceType">Invoice Type</label>
                                                    <asp:DropDownList ID="drpInvoiceType" runat="server" ClientIDMode="Static" TabIndex="6" class="select2-theme browser-default" Style="height: inherit;" >
