                                                                ...
                                                                <ItemTemplate>
                                                                    <tr class="blueShed">
                                                                        ...
                                                                        <td class="center-align">
                                                                            <asp:TextBox ID="tdQuantity" Text='<%# Eval("Quantity") %>' runat="server" ClientIDMode="Static" Width="80" TabIndex="8" MaxLength="15" AutoPostBack="true" OnTextChanged="editItem_TextChanged" />
                                                                        </td>
