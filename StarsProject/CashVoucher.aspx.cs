    ...
    public partial class CashVoucher : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                // --------------------------------------------
                lblAccountName.InnerText = "Cash A/c";
                lblCustomerName.InnerText = "Customer A/c";
            }
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (_pageValid)
            {
                ...
                objEntity.TransID = "";
                objEntity.TransDate = Convert.ToDateTime(txtVoucherDate.Text);
        ...
        public void ClearAllField()
        {
            ...
            drpVoucherType.SelectedValue = "Cash";
            txtVoucherNo.Text = "";
        ...
        protected void txtCustomerName_TextChanged(object sender, EventArgs e)
        {
            ...
            if (rptPartialTrans.Controls.Count>0)
            {
                ...
                //if (drpRecPay.SelectedValue == "Payable")
                //    drpInvoiceNo.DataSource = BAL.PurchaseBillMgmt.GetPurchaseBillNoByCustomerID(CustID);
                //else
                //    drpInvoiceNo.DataSource = BAL.SalesBillMgmt.GetSalesBillNoByCustomerID(CustID);
            ...
            //else
            //{
            //    Control myTemp = rptPartialTrans.Controls[0].Controls[0];
            //    DropDownList drpInvoiceNo = (DropDownList)myTemp.FindControl("drpInvoiceNo");
            //    drpInvoiceNo.Items.Clear();
