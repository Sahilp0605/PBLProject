...
{
    public partial class ComplaintAcupanel : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                // --------------------------------------------------------
                myAttachPanel.ResetSession("ComplaintAcu-Panel");
                myAttachDefect.ResetSession("ComplaintAcu-Defect");
                // --------------------------------------------------------
                BindDropDown();
                // --------------------------------------------------------
        ...
        public void setLayout(string v)
        {
            ...
            if (v == "Edit")
            {
                ...
                if (!String.IsNullOrEmpty(Convert.ToString(lstEntity[0].StateCode)) && Convert.ToInt64(lstEntity[0].StateCode) > 0)
                {
                    ...
                    drpState_SelectedIndexChanged1(null, null);
        ...
        public void SendAndSaveData(Boolean v)
        {
            ...
            if ((String.IsNullOrEmpty(txtNameOfCustomer.Text)) || (String.IsNullOrEmpty(txtMobileNo.Text)) || (String.IsNullOrEmpty(txtCompanyEmailID.Text)) ||
                (String.IsNullOrEmpty(txtWorkOdrNo.Text)) || (String.IsNullOrEmpty(txtdtPurchase.Text)) ||
                (String.IsNullOrEmpty(txtSiteCoordinatorName.Text)) || (String.IsNullOrEmpty(txtsiteMobileNo.Text)) ||
                (String.IsNullOrEmpty(txtConvinientDate.Text)) || (String.IsNullOrEmpty(txtComplaintNotes.Text)))
                
            {
                ...
                if (String.IsNullOrEmpty(txtConvinientDate.Text))
                    strErr += "<li>" + "Customer Convinient Date is required." + "</li>";
        ...
        protected void txtCustomerName_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                lstCust = BAL.CustomerMgmt.GetCustomerList(Convert.ToInt64(hdnCustomerID.Value), Session["LoginUserID"].ToString(), 1, 9999, out totrec);
                if (lstCust.Count>0)
                {
                    txtCompanyEmailID.Text = lstCust[0].EmailAddress;
                    txtMobileNo.Text = lstCust[0].ContactNo1;
