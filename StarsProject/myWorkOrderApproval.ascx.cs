...
{
    public partial class myWorkOrderApproval : System.Web.UI.UserControl
    {
        int ReturnCode = 0;
        string ReturnMsg = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                BindWorkOrders(drpApprovalStatus1.SelectedValue);
                BindWOStatus();
            }
        }

        public void BindWorkOrders(String pStatus)
        {
            Int64 pMon, pYear;
            ...
            rptApproval.DataSource = BAL.WorkOrderCommMgmt.GetWorkOrderCommList(pStatus, Session["LoginUserID"].ToString(), pMon, pYear);
        ...
        void BindWOStatus()
        {
            ...
            lstDesig = BAL.InquiryStatusMgmt.GetInquiryStatusList("WOApproval");
        ...
        protected void rptApproval_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                ddl.DataSource = BAL.InquiryStatusMgmt.GetInquiryStatusList("WOApproval");
            ...
            foreach (RepeaterItem i in rptApproval.Items)
            {
                ...
                if (!String.IsNullOrEmpty(hdnID.Value) && hdnID.Value != "0")
                {
                    if (hdnApprovalStatus.Value != ddl.SelectedValue)
                    {
                        ...
                        BAL.WorkOrderCommMgmt.UpdateWorkOrderApproval(objEntity, out ReturnCode, out ReturnMsg);
                    }
                }
            }
            BindWorkOrders(drpApprovalStatus1.SelectedValue);
