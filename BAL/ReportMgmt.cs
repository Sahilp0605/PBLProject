...
namespace BAL
{
    public class ReportMgmt
    {
        ...
        // ===============================================================================================
        public static List<Entity.ProductStockReport> ProductStockReportList(string pLoginUserID, string ProductGroupName, string BrandName)
        {
            List<Entity.ProductStockReport> lstObject = new List<Entity.ProductStockReport>();
            lstObject = new DAL.ReportSQL().ProductStockReportList(pLoginUserID, ProductGroupName, BrandName);
            return lstObject;
        }
        ...
        // ===============================================================================================
        public static List<Entity.Rojmel> Report_Rojmel(DateTime pToDate, String pLoginUserID)
        {
            List<Entity.Rojmel> lstObject = new List<Entity.Rojmel>();
            lstObject = new DAL.ReportSQL().Report_Rojmel(pToDate, pLoginUserID);
            return lstObject;
        }
        ...
        public static List<Entity.InquiryInfo_Report> Report_InquiryList_Report(String pReportType, Nullable<DateTime> pFromDate, Nullable<DateTime> pToDate, string pLoginUserID, string pInquirySource, string pInquiryStatus, int EmployeeID, Int64 CustomerID,string pStateCode, string pCityCode)
        {
            List<Entity.InquiryInfo_Report> lstObject = new List<Entity.InquiryInfo_Report>();
            lstObject = new DAL.ReportSQL().Report_InquiryList_Report(pReportType, pFromDate, pToDate, pLoginUserID, pInquirySource, pInquiryStatus, EmployeeID,CustomerID, pStateCode, pCityCode);
            return lstObject;
        }
        ...
        // ===============================================================================================
        public static List<Entity.OrganizationEmployee> Report_OrganizationEmployeeMasterList(string LoginUserID)
        {
            List<Entity.OrganizationEmployee> lstObject = new List<Entity.OrganizationEmployee>();
            lstObject = new DAL.ReportSQL().Report_OrganizationEmployeeMasterList(LoginUserID);
            return lstObject;
        }
