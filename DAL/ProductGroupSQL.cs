...
namespace DAL
{
    public class ProductGroupSQL:BaseSqlManager
    {
        ...
        public virtual List<Entity.ProductGroup> GetProductGroupList(Int64 pkID, string LoginUserID, int PageNo, int PageSize, out int TotalRecord)
        {
            List<Entity.ProductGroup> lstLocation = new List<Entity.ProductGroup>();
            SqlCommand cmdGet = new SqlCommand();
            cmdGet.CommandType = CommandType.StoredProcedure;
            cmdGet.CommandText = "ProductGroupList";
        ...
        public virtual List<Entity.ProductGroup> GetProductGroupList(Int64 pkID, string LoginUserID, string SearchKey, int PageNo, int PageSize, out int TotalRecord)
        {
            List<Entity.ProductGroup> lstLocation = new List<Entity.ProductGroup>();
            SqlCommand cmdGet = new SqlCommand();
            cmdGet.CommandType = CommandType.StoredProcedure;
        ...
        // ============================= Insert & Update
        public virtual void AddUpdateProductGroup(Entity.ProductGroup objEntity, out int ReturnCode, out string ReturnMsg)
        {
            SqlCommand cmdAdd = new SqlCommand();
            cmdAdd.CommandType = CommandType.StoredProcedure;
            cmdAdd.CommandText = "ProductGroup_INS_UPD";
        ...
        public virtual void DeleteProductGroup(Int64 pkID, out int ReturnCode, out string ReturnMsg)
        {
            SqlCommand cmdDel = new SqlCommand();
            cmdDel.CommandType = CommandType.StoredProcedure;
            cmdDel.CommandText = "ProductGroup_DEL";
