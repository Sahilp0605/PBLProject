...
namespace DAL
{
    public class ReportSQL : BaseSqlManager
    {
        ...
        // ==================================================================================================
        public virtual List<Entity.ProductStockReport> ProductStockReportList(string pLoginUserID,string ProductGroupName,string BrandName)
        {
            SqlCommand cmdGet = new SqlCommand();
            cmdGet.CommandType = CommandType.StoredProcedure;
        ...
        // ==================================================================================================
        public virtual List<Entity.Rojmel> Report_Rojmel(DateTime pToDate, string pLoginUserID)
        {
            SqlCommand cmdGet = new SqlCommand();
            cmdGet.CommandType = CommandType.StoredProcedure;
        ...
        public virtual List<Entity.InquiryInfo_Report> Report_InquiryList_Report(String pReportType, Nullable<DateTime> pFromDate, Nullable<DateTime> pToDate, string pLoginUserID, string pInquirySource, string pInquiryStatus, int EmployeeID, Int64 CustomerID, string pStateCode, string pCityCode)
        {
            SqlCommand cmdGet = new SqlCommand();
            cmdGet.CommandType = CommandType.StoredProcedure;
        ...
        // ==================================================================================================
        public virtual List<Entity.OrganizationEmployee> Report_OrganizationEmployeeMasterList(string LoginUserID)//string LoginUserID,Nullable<DateTime> pFromDate, Nullable<DateTime> pToDate
        {
            ...
            cmdAdd.Parameters.AddWithValue("@ListMode", "L");
            cmdAdd.Parameters.AddWithValue("@FromDate", null);
            cmdAdd.Parameters.AddWithValue("@ToDate", null);
            SqlDataReader dr = ExecuteDataReader(cmdAdd);
            // ---------------------------------------------------------
